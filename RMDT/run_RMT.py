...
parser.add_argument("--save_path", type=str, default="./rmt_basic_model.ckpt", help="Checkpoint path to save")
...
os.environ['WANDB_API_KEY'] = 'YOUR WANDB TOKEN'
wandb.init(project="YOUR NAME", name=str(user_config))
